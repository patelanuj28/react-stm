...
module.exports = function(app,callback) {
    ...
    buster.load(function(err,viewDataMixin) {
        ...
        app.get('/socket.io*',function(req,res) {
            res.statusCode = 502;
            res.write('You are not running this application via webpack-dev-server. Browse to this application using the webpack-dev-server port to enable webpack support');
            res.end();
        });
